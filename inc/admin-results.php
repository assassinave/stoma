  ...
  <div class="scroll">
    <table class="admin">
      ...
      <tr>
        ...
        <td class="submit"><div class="btn"><a href="admin-results-detail.php?id=<?php echo $data["user_id"]; ?>" class="admin">View</a><img src="images/svg/button-end.svg" height="55px"/></div></td>
      </tr>
      <?php } ?>
    </table>
  </div>
