<div class="container">
  ...
  <h3>Good Luck!</h3>
  <div class="btn"><a href="nurse-registration.php" class="button">Nurse Registration</a></div>
  <div class="btn"><a href="team-registration.php" class="button">Team Registration</a></div>
</div>
